...
$sql = "SELECT * FROM `result` WHERE CGPI BETWEEN $lb AND $ub";
$result = mysqli_query($db,$sql);

if (mysqli_num_rows($result) > 0) {
echo '<div class="display-or" style="background-color: #f9f9f9; ">';
  echo '
  <div style="overflow-x:auto;background-color: #f9f9f9;">
  <table>
